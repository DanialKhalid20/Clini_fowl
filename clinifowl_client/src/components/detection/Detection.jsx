            ...
            <div className="main flex flex-col lg:flex-row w-full max-w-6xl">
                    ...
                    {detections.length > 0 && (
                        <ul className="mt-4 space-y-2 w-full">
                            {detections.map((detection, index) => (
                                <li key={index} className="p-2 bg-darkalabaster rounded-lg flex justify-between items-center text-lg">
                ...
                <div className="flex flex-col items-center justify-center w-full lg:w-1/2 p-4">
                    ...
                    <div className="txt text-center mt-4">
                        <h1 className="text-3xl font-bold mb-2">Detecting Diseases Using Fecal Images</h1>
                    ...
                    <div className="uploadimg flex flex-col sm:flex-row items-center justify-center mt-4 space-y-4 sm:space-y-0 sm:space-x-4">
                        ...
                        />
                        <button onClick={handleSubmit} className="bg-sienna text-white py-2 px-4 rounded-lg hover:bg-opacity-90 whitespace-nowrap">
                            Upload Photo
                        </button>
                    </div>
                </div>
